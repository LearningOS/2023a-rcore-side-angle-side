...
use crate::{
    ...
    task::{
        ...
        get_current_run_time, get_current_task_status, get_syscall_times, mmap, munmap,
        set_priority, suspend_current_and_run_next, TaskStatus,
    },
...
pub fn user_memory_set<T: Sized>(ptr: *mut T, val: &T) -> isize {
    let len = size_of::<T>();
